    ...
    public class RTMPVideoProvider extends EventDispatcher implements IProvider{
        ...
        public function set src(pSrc:Object):void{
            ...
            if(_isPlaying){
                ...
                _src = pSrc;
               // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start GGGG1111");

                initNetConnection();
               // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start GGGG");

            }
            else{
                init(pSrc, false);
                //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start RRRR");
        ...
        public function play():void{
            ...
            if(!_loadStarted){
                ...
                _metadata = {};
                initNetConnection();
                //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start play: NetStream.Buffer.start play1");
            ...
            // if the asset is paused
                ...
                //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start play: NetStream.Buffer.start play2");
            ...
            // video playback ended, seek to beginning
                ...
                _isBuffering = true;
                _model.broadcastEventExternally(ExternalEventName.ON_RESUME);
                //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start play: NetStream.Buffer.start play3");

            }
        }

        public function pause():void{
            //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start pause: NetStream.Buffer.start pause0"+_isPlaying+"   "+_isPaused);

            if(_isPlaying && !_isPaused){
                _ns.pause();
                _isPaused = true;
                _model.broadcastEventExternally(ExternalEventName.ON_PAUSE);
                ///ExternalInterface.call("console.log", "[VIDEOJS-SWF] start pause: NetStream.Buffer.start pause2");

                if(_isBuffering){
                    _pausePending = true;
                    //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start pause: NetStream.Buffer.start pause3");
                ...
                _isPaused = true;
                _model.broadcastEventExternally(ExternalEventName.ON_PAUSE);
                //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start pause: NetStream.Buffer.start pause1");
               ...
               // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start pause: NetStream.Buffer.start pause4");
        ...
        public function resume():void{
            //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start resume0: NetStream.Buffer.start resume0");

            if(_isPlaying && _isPaused){
                _ns.resume();
                _isPaused = false;
                _model.broadcastEventExternally(ExternalEventName.ON_RESUME);
              //  ExternalInterface.call("console.log", "[VIDEOJS-SWF] start resume1: NetStream.Buffer.start resume1");
        ...
        public function stop():void{
           // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop0: NetStream.Buffer.start stop0");
            ...
            if(_isPlaying){
              ...
              //  ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start stop2");
        ...
        private function initNetConnection():void{
            if(_nc == null){
               ...
               // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start AAAA");
            ...
            if(_nc.connected){
                if(_src.connectionURL != _nc.uri){
                   ...
                   // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start DDDD");
                }
                else{
                    initNetStream();
                    _nc.connect(_src.connectionURL);
                   // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start BBB");

                }
            }
            else{
                _nc.connect(_src.connectionURL);
               // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start CCCC");

            }
        }

        private function initNetStream():void{
           // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start QQQQ");

            if(_ns != null){
                _ns.removeEventListener(NetStatusEvent.NET_STATUS, onNetStreamStatus);
                _ns = null;

               // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start TTT");
            ...
            _ns.videoReliable = false;
            _ns.dataReliable = false;
           // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start YYYY"+_src.streamURL);
           ...
           // ExternalInterface.call("console.log", "[VIDEOJS-SWF] start stop2: NetStream.Buffer.start HHH");
        ...
        private function onNetStreamStatus(e:NetStatusEvent):void{
            switch(e.info.code){
                case "NetStream.Play.Reset":
                   // ExternalInterface.call("console.log", "[VIDEOJS-SWF] reset: NetStream.Buffer.reset");
                    break;
                case "NetStream.Buffer.Flush":
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: NetStream.Buffer.Flush");
...
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bytesLoaded = " + _ns.bytesLoaded);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bytesTotal = " + _ns.bytesTotal);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.currentFPS = " + _ns.currentFPS);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.liveDelay = " + _ns.liveDelay);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.time = " + _ns.time);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.backBufferLength = " + _ns.backBufferLength);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.backBufferTime = " + _ns.backBufferTime);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bufferTimeMax = " + _ns.bufferTimeMax);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.farID = " + _ns.farID);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.inBufferSeek = " + _ns.inBufferSeek);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.info = " + _ns.info);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.maxPauseBufferTime = " + _ns.maxPauseBufferTime);
                ...
                case "NetStream.Play.Start":
                    ...
                    _loadStarted = true;
                    //ExternalInterface.call("console.log", "[VIDEOJS-SWF] start: NetStream.Buffer.start");

                    break;

                case "NetStream.Buffer.Full":
                    // Sometimes bug on start NetStream: empty buffer
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: NetStream.Buffer.Full2");
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bufferTime = " + _ns.bufferTime);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bufferLength = " + _ns.bufferLength);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bytesLoaded = " + _ns.bytesLoaded);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.bytesTotal = " + _ns.bytesTotal);
...
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.info = " + _ns.info);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.maxPauseBufferTime = " + _ns.maxPauseBufferTime);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.nearNonce = " + _ns.nearNonce);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.videoReliable = " + _ns.videoReliable);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.useHardwareDecoder = " + _ns.useHardwareDecoder);
//                    ExternalInterface.call("console.log", "[VIDEOJS-SWF] onNetStreamStatus: _ns.dataReliable = " + _ns.dataReliable);
                ...
                case "NetStream.Buffer.Empty":
                    ...
                    if (_hasEnded) {
                        if(!_loop){
                            ...
                            //ExternalInterface.call("console.log", "[VIDEOJS-SWF] emptt1: NetStream.Buffer.emptt1");
                        }
                        else{
                            _ns.seek(0);
                            //ExternalInterface.call("console.log", "[VIDEOJS-SWF] emptt2: NetStream.Buffer.emptt2");
                    ...
                    // other stream buffering
                        ...
                        _isBuffering = true;
                        _model.broadcastEventExternally(ExternalEventName.ON_BUFFER_EMPTY);
                        //ExternalInterface.call("console.log", "[VIDEOJS-SWF] emptt3: NetStream.Buffer.emptt3");
                    }
                ...
                case "NetStream.Play.Stop":
                    ...
                    _throughputTimer.stop();
                    _throughputTimer.reset();
                   // ExternalInterface.call("console.log", "[VIDEOJS-SWF] stop: NetStream.Buffer.stop");
                ...
                case "NetStream.Seek.Notify":
                    ...
                    _throughputTimer.reset();
                    _throughputTimer.start();
                    //ExternalInterface.call("console.log", "[VIDEOJS-SWF] Notify: NetStream.Buffer.Notify");
